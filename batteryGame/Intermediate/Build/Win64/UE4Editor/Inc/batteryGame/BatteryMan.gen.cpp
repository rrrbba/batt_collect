...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ABatteryMan_OnBeginOverlap_Statics::Function_MetaDataParams[] = {
		{ "Comment", "//going to be tied to a delegate\n" },
		{ "ModuleRelativePath", "BatteryMan.h" },
		{ "ToolTip", "going to be tied to a delegate" },
	};
#endif
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ABatteryMan_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ABatteryMan_OnBeginOverlap, "OnBeginOverlap" }, // 563023546
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ABatteryMan_Statics::NewProp_Power_MetaData[] = {
		{ "Category", "BatteryMan" },
		{ "Comment", "//access this variable inside of a blueprint, need the bpro so we can access it\n" },
		{ "ModuleRelativePath", "BatteryMan.h" },
		{ "ToolTip", "access this variable inside of a blueprint, need the bpro so we can access it" },
	};
#endif
	...
	IMPLEMENT_CLASS(ABatteryMan, 2328380650);
